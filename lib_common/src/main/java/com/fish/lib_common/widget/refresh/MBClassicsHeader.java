package com.fish.lib_common.widget.refresh;
...
public class MBClassicsHeader extends InternalClassics<MBClassicsHeader> implements RefreshHeader {
...
//    public static String REFRESH_HEADER_UPDATE = "'Last update' M-d HH:mm";
    ...
    public MBClassicsHeader(Context context) {
        this(context, null);
    }

    public MBClassicsHeader(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MBClassicsHeader(Context context, AttributeSet attrs, int defStyleAttr) {
...
//    }
    ...
    public MBClassicsHeader setLastUpdateTime(Date time) {
        final View thisView = this;
        mLastTime = time;
    ...
    public MBClassicsHeader setTimeFormat(DateFormat format) {
    ...
    public MBClassicsHeader setLastUpdateText(CharSequence text) {
        mLastTime = null;
        mLastUpdateText.setText(text);
        return this;
    }

    public MBClassicsHeader setAccentColor(@ColorInt int accentColor) {
        mLastUpdateText.setTextColor(accentColor&0x00ffffff|0xcc000000);
        return super.setAccentColor(accentColor);
    }

    public MBClassicsHeader setEnableLastTime(boolean enable) {
        final View updateView = mLastUpdateText;
...
//            mRefreshKernel.requestRemeasureHeightForHeader();
    ...
    public MBClassicsHeader setTextSizeTime(float size) {
...
//    }
    ...
    public MBClassicsHeader setTextTimeMarginTop(float dp) {
        final View updateView = mLastUpdateText;
