...
/**
 * Created by xieshulan on 2019/6/6.
 * 可指定最大高度的View
 */
...
public class MaxHeightView extends FrameLayout {
    ...
    public MaxHeightView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initAttrs(context, attrs);
        init();
    }

    public MaxHeightView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
